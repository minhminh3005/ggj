  ...
  <div class="w-1000">
    ...
    <div class="list-product p-20 mt-20">
      ...
      <div class="flex center mt-20">
        <a class="flex mid center best-more" href="/th/systemtrade/sell/fx">
          {{ $t('3') }}
        </a>
      </div>
      <template v-if="rtRanking.length">
        ...
        <div class="flex center mt-20">
          <a class="flex mid center best-more" href="/th/systemtrade/realasset">
            {{ $t('3') }}
          </a>
        </div>
      </template>
    ...
    <div class="flex space-between mt-20 mb-50">
        ...
        <LazyComp01 class="flex space-between mt-20" min-height="450px">
          <div class="w50p list-product flex layout-col pt-20">
            ...
            <ShowMore
              class="bg-dot"
              :text="$t('10')"
              :target="'/th/systemtrade/profitrate/fx'"
            />
          </div>
          <div class="w50p list-product flex layout-col pt-20">
            <div class="flex mid ml-20 mb-10">
            ...
            <ShowMore
              class="bg-dot"
              :text="$t('10')"
              :target="'/th/systemtrade/profit/fx'"
            />
          </div>
        </LazyComp01>
        <LazyComp01 class="flex space-between mt-20" min-height="450px">
          <div class="w50p list-product flex layout-col pt-20">
            ...
            <ShowMore
              class="bg-dot"
              :text="$t('10')"
              :target="'/th/systemtrade/profitfactor/fx'"
            />
          </div>
          <div class="w50p list-product flex layout-col pt-20">
            <div class="flex ml-20 mb-10">
            ...
            <ShowMore
              class="bg-dot"
              :text="$t('10')"
              :target="'/th/systemtrade/riskreturn/fx'"
            />
          </div>
        </LazyComp01>
        <LazyComp01 class="flex space-between mt-20" min-height="450px">
      ...
      <div class="right-content">
        ...
        <ShowMore
          class="fs-12 mt-5"
          :text="$t('5')"
          :target="'/th/systemtrade/newproduct/fx'"
        />
      </div>
    </div>
  </div>
