...
const obj = Object.assign(
  {
    ...
    async asyncData({ app, params, error, store, query }) {
      ...
      store.commit('pushBC', {
        name: detail.name,
        target: { name: 'th-systemtrade-index-fx-id', params: params },
      })
      store.commit('pushBC', {
        name: titleChunk,
        target: { name: 'th-systemtrade-index-fx-id-backtest', params: params },
      })
      return {
        id,
        qTab,
        ...
        linkMeta: [
          {
            rel: 'canonical',
            href: `https://www.gogojungle.co.jp/th/systemtrade/fx/${id}/backtest`,
          },
        ],
      }
    },
