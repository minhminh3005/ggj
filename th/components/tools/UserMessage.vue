<template>
  <div class="flex p-20">
    <div>
      <gogo-link :target="'/users/'+ message.userId">
    ...
    <div class="w-full ml-30 message-wrapp">
      <div class="flex space-between">
        ...
        <span v-if="message.userId == userId && message.id" @click="onDelete" class="glyphicon glyphicon-remove cursor-pointer" aria-hidden="true"/>
      </div>
      <div class="mb-0 border-radius-5 grow0 mt-10">
        ...
        <div class="pre-line" v-html="message.content"/>
      </div>
