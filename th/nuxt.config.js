...
module.exports = Object.assign(
  ...
  head: {
    ...
    script: [
      {
        src: 'https://embed.small.chat/T8WCY8AD7G010XNC7CJE.js',
        async: '',
      }
    ],
  },
  ...
  plugins: [
    ...
    {
      src: '@@/../common/plugins/fb-pixel-th.js',
      ssr: false,
    },
    {
  ...
  modules: [
    '@@/../bin/configs.js',
    ['@@/../common/modules/hook-render.js', 'desktop Thailand'],
  ],
  serverMiddleware: [
    {
      path: '/health',
