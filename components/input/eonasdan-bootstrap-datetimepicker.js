    ...
    var dateTimePicker = function(element, options) {
        var picker = {},
          ...
          hasTimeZone = function() {
              return moment.tz !== undefined && options.timeZone !==
                undefined && options.timeZone !== null && options.timeZone !==
                ''
          },
          ...
          getMoment = function(d) {
              ...
              if (d === undefined || d === null) {
                  ...
                  returnMoment = moment.tz(d, parseFormats, options.useStrict,
                    options.timeZone)
              } else {
          ...
          getDatePickerTemplate = function() {
              var headTemplate = $('<thead>')
                  .append($('<tr>')
                    .append(
                      $('<th>').addClass('prev').attr('data-action', 'previous')
          ...
          place = function() {
              ...
              widget.css({
                  ...
                  bottom: vertical === 'top' ? parent.outerHeight() -
                    (parent === element ? 0 : position.top) : 'auto',
          ...
          updateDecades = function() {
              ...
              while (!startDecade.isAfter(endDecade, 'y')) {
                  ...
                  html += '<span data-action="selectDecade" class="decade' +
                    ...
                    !maxDateDecade ? ' disabled' : '') + '" data-selection="' +
          ...
          fillDate = function() {
              ...
              for (i = 0; i < 42; i++) { //always display 42 days (should show 6 weeks)
                  ...
                  row.append('<td data-action="selectDay" data-day="' +
                    currentDate.format('L') + '" class="' + clsNames.join(' ') +
                    '">' + currentDate.date() + '</td>')
                  currentDate.add(1, 'd')
              }
          ...
          show = function() {
              ...
              } else if (unset && options.useCurrent && (options.inline ||
                    ...
                    typeof (options.keyBinds[index]) === 'function') {
                      ...
                      if (keyBindKeys.length === pressedKeys.length &&
                        ...
                        keyBindKeys[keyBindKeys.length - 1]) {
                          ...
                          for (index2 = keyBindKeys.length - 2; index2 >=
                          0; index2--) {
        ...
        if (input.is('input') && input.val().trim().length !== 0) {
            setValue(parseInputDate(input.val().trim()))
        } else if (options.defaultDate && input.attr('placeholder') ===
          undefined) {
            setValue(options.defaultDate)
        }
        if (options.inline) {
        ...
        if (typeof options === 'object') {
            return this.each(function() {
                ...
                if (!$this.data('DateTimePicker')) {
                    ...
                    _options = $.extend(true, {}, $.fn.datetimepicker.defaults,
                      options)
            ...
            this.each(function() {
                ...
                if (!instance) {
                    throw new Error('bootstrap-datetimepicker("' + options +
