<template>
  <section>
    ...
    <GogoModal :show="isShowModal" :cancel-text="$t('22')" @close="onClose" @ok="onGoToRegister" :ok-text="'OK'" :width="'400px'" :height="'auto'">
...
export default {
  ...
  methods: {
    ...
    onGoToRegister() {
      location.href = `/register?u=/systemtrade/stocks/${this.$route.params.id}`
    },
    onClose() {
