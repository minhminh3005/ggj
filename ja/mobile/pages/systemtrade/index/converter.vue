<template>
  <div class="converter p-10">
    <div class="main-title mt-10">
      <b>{{ $t('2') }}</b>
    </div>
    <img src="/img/assets/pc/systemtrade/converter.png" width="100%" height="auto" alt="converter main pic" />
    <div class="convert-area flex flex-wrap mt-20">
      <div class="w-full">
        <div><b>{{ $t('3') }}</b></div>
    ...
    <GogoModal :show="isShowModal" @update:show="val => isShowModal = val" :width="300" :height="200" :cancel-text="$t('10')" :ok-text="$t('9')" @ok="onGoToLogin">
...
import i18n from '@@/lang/mobile/systemtrade-converter.json'
