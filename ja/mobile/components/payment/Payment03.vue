  ...
  <div class="payment-5aRYi">
    ...
    <div class="main-info">
        ...
        <div class="group-2 flex layout-col mid">
          <div class="price-wrapp" v-if="!info.isRangePrice">
            ...
            <p v-if="info.oldPrice" class="ref-price co-red flex mid mb-0">
              ...
              <span class="main-price"><b>{{ info.price ? '￥' + formatNumber(infoPrice) : $t('12') }}</b></span>
            ...
            <p v-else class="mb-0">
              ...
              <span class="main-price"><b>{{ infoPrice ? '￥' + formatNumber(infoPrice) : $t('12') }}</b></span>
              <span class="title01">{{ $t('10') }}</span>
            </p>
          </div>
          <div class="mb-10 flex mid center" v-if="info.price && info.isSub">
            <b v-if="info.isYearly" class="ml-5 fs-16">{{ $t('52') }}</b>
            <b v-else class="ml-5 fs-16">{{ $t('24') }}</b>
            <b class="ml-5 fs-16" v-if="info.isFFM">{{ $t('49') }}</b>
          </div>
      ...
      <div class="group-3 flex layout-col mid">
        ...
        <div v-if="payments.bank && !info.externalUrl">
          <!-- <p class="m-0">
            <span>{{ $t('18') }}</span>
            <b>{{ $t('19') }}</b>
          </p> -->
          <!-- <img src="/img/assets/pc/common/msg_systemtrade.png" alt="" style="width: 92vw; height: auto;" v-if="info.type == 1" />
          <img src="/img/assets/pc/common/msg_tools.png" alt="" style="width: 92vw; height: auto;" v-else /> -->
        </div>
        <LazyComp01 min-height="110px" class="cart-info-cash" v-if="!info.externalUrl">
          ...
          <div class="flex flex-wrap">
            ...
            <img v-if="payments.card2 === 1" :src="'/img/assets/pc/common/payment_ico_jcb.png'" alt="" />
