...
import i18n from '@@/lang/components-mobile/bubble-chart02.json'
      ...
      me.innerChart = HighCharts.chart(me.$refs.chartWrap, {
        ...
        tooltip: {
          ...
          pointFormatter: function () {
            return `<tr>
            <th colspan="2"><h3><a target="_blank" href="${this.detailUrl}">${this.name}</a></h3></th></tr>
            <tr>
              ...
              events: {
                dblclick: function (event) {
                  if ((event.point || {}).detailUrl) {
                    window.location = event.point.detailUrl
                  }
                },
              }
            },
