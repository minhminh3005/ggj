  ...
  <div class="pos-abs l-line" :style="{ top: y+'px', left: x+'px' }">
    <div class="pos-rel">
      <svg :height="height" :width="width">
        <line :x1="l1.x1" :y1="l1.y1" :x2="l1.x2" :y2="l1.y2" style="stroke: black;" :style="{ 'stroke-width': strokeWidth }"/>
        <line :x1="l2.x1" :y1="l2.y1" :x2="l2.x2" :y2="l2.y2" style="stroke: black;" :style="{ 'stroke-width': strokeWidth }"/>
      </svg>
      <slot>
        <a ref="nLable" :href="lable.titleUrl" class="cursor-pointer pos-abs title fs-11" :style="{ top: (lable.y || textPos)+'px', left: (lable.x || (width + 5))+'px'}">
          {{ lable.title }}
        </a>
      </slot>
    </div>
