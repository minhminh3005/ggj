<template>
  <div class="error-page flex layout-col-mid pl-10 pr-10">
    <div>
      <h3 class="mt-30 mb-30" style="font-weight: bold;">
        {{ error.exists ? $t('5') : $t('1') }}
      </h3>
      <div class="flex flex-wrap layout-row">
        <img class="mb-15" src="/img/assets/pc/common/robot2.png" alt="robot-error" style="width: 137px; height: 120px;" />
