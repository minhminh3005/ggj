  ...
  <div class="product-BjNGX p-10">
    <gogo-link :target="product.detailUrl" :title="product.name">
      <div class="product-img pos-rel mb-10">
        ...
        <img :data-src="`/img/products/${product.id}/small`" :style="`width: ${size[0]}px; height: ${size[1]}px`" alt="" v-if="product.typeId && product.typeId != 1 && !product.articleId" :class="{'owl-lazy': isLz}" />
        <img :data-src="`/img/articles/${product.articleId}/small`" :style="`width: ${size[0]}px; height: ${size[1]}px`" alt="" v-else-if="product.typeId && product.typeId != 1 && product.articleId" :class="{'owl-lazy': isLz}" />
